...
public class CustomerServiceImp implements ICustomerService {
	...
	@Override
	public void deleteProductByCustomerId(int customerId, Product product) {
		
		
		 restTemplate.put("http://localhost:8282/api/products/delete", product);
		 System.out.println("product deleted from customer MS " );
		
	}

	@Override
	public Product insertProductByCustomer(Product product) {
		
		return restTemplate.put("http://localhost:8282/api/products/add", product);;
	}
