...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponseMessage> handleException(BusIdNotFoundException b) {
		ErrorResponseMessage errorResponseMessage = new ErrorResponseMessage(b.getMessage(), "NOT_FOUND");
